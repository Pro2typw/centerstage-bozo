...
public class PurplePixelPipeline extends OpenCvPipeline {
    public int tolerance = 50;
    private final Scalar selectedValue = new Scalar(133, 134, 166);
    ...
    public PurplePixelPipeline(Telemetry telemetry) {
