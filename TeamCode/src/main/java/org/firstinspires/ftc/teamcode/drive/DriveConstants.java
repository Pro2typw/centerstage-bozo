...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = .9939492746; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 13.22; // in
    ...
    public static double MAX_ANG_VEL = 25.566649354013673;
